# Average rent paid per turn for Dice Roll followed by a Bus Ticket

import Simulation
import datetime

N = 1000000
fname = datetime.datetime.now().strftime("DiceRollAndBusTicketAnalysis %I:%M:%S %p on %B %d, %Y")

with open(fname,'a') as out:
    out.write("Average rents paid for Dice Rolls followed by a Bus Ticket on %r iterations\n"%(N))
